...
export const classNames = {
  ...
  icon: 'text-theme-300 dark:text-theme-500 hover:text-theme-blue hover:dark:text-theme-blue',
  ...
  toggleShrink: 'text-theme-300 dark:text-theme-100 hover:text-theme-200 hover:dark:text-theme-blue',
}
